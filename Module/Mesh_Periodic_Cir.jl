...
struct PeriodicCirGeometry
    ...
    rd::Float64          # Center circle radius of raman molecule
...
function MeshGenerator(geo_param::PeriodicCirGeometry, meshfile_name::String)
    gmsh.initialize()
    ...
    gmsh.model.geo.addPoint(0,  geo_param.hd/2, 0, geo_param.l2, 17)
    gmsh.model.geo.addPoint(-geo_param.rd,  geo_param.hd/2, 0, geo_param.l2, 18)
    gmsh.model.geo.addPoint( geo_param.rd,  geo_param.hd/2, 0, geo_param.l2, 19)
    # Add lines
    ...
    gmsh.model.geo.addCircleArc( 18, 17, 19, 23)
    gmsh.model.geo.addCircleArc( 19, 17, 18, 24)
    # Construct curve loops and surfaces 
    gmsh.model.geo.addCurveLoop([23, 24], 8)
    gmsh.model.geo.addPlaneSurface([8], 8)
    gmsh.model.geo.addCurveLoop([1, 2, -3, -4], 1)
    gmsh.model.geo.addPlaneSurface([1], 1)
    gmsh.model.geo.addCurveLoop([3, 5, -6, -7], 2)
    gmsh.model.geo.addPlaneSurface([2, 8], 2)
    ...
    gmsh.model.addPhysicalGroup(2, [8], 11)
    gmsh.model.setPhysicalName(2, 11, "CenterCircle")
