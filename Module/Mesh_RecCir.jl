...
# geo = RecCirGeometry(L, h1, h2, rt, rd, rs, dpml, l1, l2)
# MeshGenerator(geo, "geometry.msh")
...
struct RecCirGeometry
    ...
    rs::Float64          # Radius of smallest distance
...
function MeshGenerator(geo_param::RecCirGeometry, meshfile_name::String)
    ...
    gmsh.model.geo.addPoint(-geo_param.rt,  geo_param.h1/2, 0, geo_param.l2, 12)
    gmsh.model.geo.addPoint( geo_param.rt,  geo_param.h1/2, 0, geo_param.l2, 13)
    # Add lines
    ...
    gmsh.model.geo.addCircleArc(12, 7,13,12)
    gmsh.model.geo.addCircleArc(13, 7,12,13)
    ...
    gmsh.model.geo.addCurveLoop([12, 13], 3)
    gmsh.model.geo.addPlaneSurface([3, 2], 3)
    gmsh.model.geo.addCurveLoop([1, 2, -7,-6], 4)
    gmsh.model.geo.addPlaneSurface([4, 3], 4)
    ...
    gmsh.model.addPhysicalGroup(1, [12, 13], 8)
